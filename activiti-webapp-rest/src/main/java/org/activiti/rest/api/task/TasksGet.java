...
//    }
        ...
        List<TTaskAbstract> tasks = null;
        try {

            tasks = humanTaskService.getMyTaskAbstracts(null, personalTaskUserId, null, null, null, null, null, null, null);
        } catch (IllegalStateFault ex) {
            Logger.getLogger(TasksGet.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (tasks != null) {
            ...
            for (TTaskAbstract t : tasks) {
                RestTask restTask = new RestTask(t);
